				...
				<div class="collapse navbar-collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="active"class="dropdown"><a href="#">Page <i class="fa fa-angle-down"></i></a>
							...
							<li class="active"><a href="it_test">Coding Test</a></li>
                   	 ...
                   	 <div class="sidebar-item categories">
                           <h3>Test</h3>
                            <ul class="nav navbar-stacked">
                                <li><a href="j_test">Japanese Test<span class="pull-right"><i class="fa fa-arrow-right"></i></span></a></li>
                                <li class="active"><a href="it_test">Coding Test<span class="pull-right"><i class="fa fa-arrow-right"></i></span></a></li>
						...
						<div class="col-md-12 col-sm-12">
							<div class="single-blog two-column">
								...
								<div class="post-content overflow">
									<h3 class="post-title bold" id="1">1번 .
										10時半頃、男の人は何をしていましたか。</h3>
							...
							<div class="single-blog two-column">
								...
								<div class="post-content overflow">
									...
									<div class="post-bottom overflow" id="103">
										...
										<input type="radio" name="three" id="j-three" value="2"><label
											for="j-three">お風呂に入っていた</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="radio" name="three" id="j-two" value="3"><label
											for="j-three">お風呂に入っていた</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="radio" name="three" id="j-three" value="4"><label
											for="j-three">お風呂に入っていた</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									</div>
								</div>
							</div>
