						...
						<div class="sidebar portfolio-sidebar">
							<div class="sidebar-item categories">
								...
								<ul class="nav navbar-stacked">
									...
									<li class="active"><a href="japanese_fairy_2intermediate">중급<span class="pull-right"><i class="fa fa-arrow-right"></i></span></a></li>
				...
				<ul class="bb-custom-grid" id="bb-custom-grid">
					<li>
						...
						<div class="bb-bookblock">
							<div class="bb-item">
								<a href="#"><img src="images/learningPage/장화신은 고양이1.png" alt="image01" /></a>
							</div>
							<div class="bb-item">
