...
<head>
	...
	<title>Triangle - Creative Multipurpose HTML Template</title>
	
	<meta name="description" content="Triangle is a creative multipurpose responsive html template. This amazing template is suitable for any kind of small business or creative farms. Creative design, stunning animations, single and multi-color variations are the main features of this template.">
	<meta name="author" content="Themeum">
	<meta name="copyright" content="Themeum">
	<meta name="generator" content="Documenter v2.0 http://rxa.li/documenter">
	<meta name="date" content="2014-06-13T00:00:00+02:00">
	
	<link rel="stylesheet" href="bootstrap/css/documenter_style.css" media="all">
	<link rel="stylesheet" href="bootstrap/js/google-code-prettify/prettify.css" media="screen">
...
<body class="documenter-project-triangle">
	<div id="documenter_sidebar">
		<a href="#documenter_cover" id="documenter_logo"></a>
		<ul id="documenter_nav">
			<li><a class="current" href="#documenter_cover">Start</a></li>
				
			<li><a href="#ajax_contact_form" title="Ajax Contact Form">Ajax Contact Form</a></li>
	...
	<h1>Triangle</h1>
	<h2>Creative Multipurpose HTML Template</h2>
	<div id="documenter_buttons">
		<a href="http://themeforest.net/user/themeum/portfolio" class="btn btn-primary btn-large">All Themes</a> <a href="http://www.themeum.com/" class="btn btn-large">Website</a> <a href="http://www.themeum.com/questions" class="btn btn-large">Support</a> 
	</div>
	<hr>
	<ul>
	<li>created: 06/13/2014</li>
	<li>latest update: 06/13/2014</li>
	<li>by: Themeum</li>
	<li><a href=""></a></li>
	<li>email: <a href="mailto:&#115;&#117;&#112;&#112;&#111;&#114;&#116;&#64;&#116;&#104;&#101;&#109;&#101;&#117;&#109;&#46;&#99;&#111;&#109;">&#115;&#117;&#112;&#112;&#111;&#114;&#116;&#64;&#116;&#104;&#101;&#109;&#101;&#117;&#109;&#46;&#99;&#111;&#109;</a></li>
	</ul>
	<p>Triangle is a creative multipurpose responsive html template. This amazing template is suitable for any kind of small business or creative farms. Creative design, stunning animations, single and multi-color variations are the main features of this template.</p>
	</section>
	
	<section id="ajax_contact_form">
	<div class="page-header"><h3>Ajax Contact Form</h3><hr class="notop"></div>
<p>
	Open <strong>sendemail.php&nbsp;</strong>file using any text editor like sublime text or notepad++ and look for the line&nbsp;<strong>&#101;&#109;&#97;&#105;&#108;&#64;&#101;&#109;&#97;&#105;&#108;&#46;&#99;&#111;&#109;.</strong></p>
<p>
	Just replace that email with your one and save the file.</p>
...
<p>
	In <strong>main.js</strong> file under <strong>js</strong> folder just look for the latitude and logitude value. Replace that values using correct one and save the file to see your address.</p>
        ...
        &lt;div class=&quot;navbar navbar-inverse&quot; role=&quot;banner&quot;&gt;
            ...
            &lt;div class=&quot;container&quot;&gt;
                ...
                &lt;div class=&quot;navbar-header&quot;&gt;
                    ...
                    <span class="Apple-tab-span" style="white-space:pre"> </span>&lt;h1&gt;&lt;img src=&quot;images/logo.png&quot; alt=&quot;logo&quot;&gt;&lt;/h1&gt;
...
<p class="prettyprint lang-js linenums">
	jQuery(function($) {&#39;use strict&#39;;</p>
<p class="prettyprint lang-js linenums">
	//Responsive Nav</p>
<p class="prettyprint lang-js linenums">
	$(&#39;li.dropdown&#39;).find(&#39;.fa-angle-down&#39;).each(function(){</p>
<p class="prettyprint lang-js linenums">
	$(this).on(&#39;click&#39;, function(){</p>
<p class="prettyprint lang-js linenums">
	if( $(window).width() &lt; 768 ) {</p>
<p class="prettyprint lang-js linenums">
	$(this).parent().next().slideToggle();</p>
<p class="prettyprint lang-js linenums">
	}</p>
<p class="prettyprint lang-js linenums">
	return false;</p>
...
<p class="prettyprint lang-js linenums">
	//Fit Vids</p>
<p class="prettyprint lang-js linenums">
	if( $(&#39;#video-container&#39;).length ) {</p>
<p class="prettyprint lang-js linenums">
	$(&quot;#video-container&quot;).fitVids();</p>
<p class="prettyprint lang-js linenums">
	}</p>
<p class="prettyprint lang-js linenums">
	//Initiat WOW JS</p>
...
<p class="prettyprint lang-js linenums">
	$(&#39;.main-slider&#39;).addClass(&#39;animate-in&#39;);</p>
<p class="prettyprint lang-js linenums">
	$(&#39;.preloader&#39;).remove();</p>
<p class="prettyprint lang-js linenums">
	//End Preloader</p>
<p class="prettyprint lang-js linenums">
	if( $(&#39;.masonery_area&#39;).length ) {</p>
<p class="prettyprint lang-js linenums">
	$(&#39;.masonery_area&#39;).masonry();//Masonry</p>
<p class="prettyprint lang-js linenums">
	}</p>
<p class="prettyprint lang-js linenums">
	var $portfolio_selectors = $(&#39;.portfolio-filter &gt;li&gt;a&#39;);</p>
<p class="prettyprint lang-js linenums">
	if($portfolio_selectors.length) {</p>
<p class="prettyprint lang-js linenums">
	var $portfolio = $(&#39;.portfolio-items&#39;);</p>
<p class="prettyprint lang-js linenums">
	$portfolio.isotope({</p>
<p class="prettyprint lang-js linenums">
	itemSelector : &#39;.portfolio-item&#39;,</p>
<p class="prettyprint lang-js linenums">
	layoutMode : &#39;fitRows&#39;</p>
<p class="prettyprint lang-js linenums">
	});</p>
<p class="prettyprint lang-js linenums">
	$portfolio_selectors.on(&#39;click&#39;, function(){</p>
<p class="prettyprint lang-js linenums">
	$portfolio_selectors.removeClass(&#39;active&#39;);</p>
<p class="prettyprint lang-js linenums">
	$(this).addClass(&#39;active&#39;);</p>
<p class="prettyprint lang-js linenums">
	var selector = $(this).attr(&#39;data-filter&#39;);</p>
<p class="prettyprint lang-js linenums">
	$portfolio.isotope({ filter: selector });</p>
<p class="prettyprint lang-js linenums">
	return false;</p>
<p class="prettyprint lang-js linenums">
	});</p>
...
<p class="prettyprint lang-js linenums">
	$(&#39;.timer&#39;).each(count);</p>
<p class="prettyprint lang-js linenums">
	function count(options) {</p>
<p class="prettyprint lang-js linenums">
	var $this = $(this);</p>
<p class="prettyprint lang-js linenums">
	options = $.extend({}, options || {}, $this.data(&#39;countToOptions&#39;) || {});</p>
<p class="prettyprint lang-js linenums">
	$this.countTo(options);</p>
<p class="prettyprint lang-js linenums">
	}</p>
<p class="prettyprint lang-js linenums">
	// Search</p>
<p class="prettyprint lang-js linenums">
	$(&#39;.fa-search&#39;).on(&#39;click&#39;, function() {</p>
<p class="prettyprint lang-js linenums">
	$(&#39;.field-toggle&#39;).fadeToggle(200);</p>
<p class="prettyprint lang-js linenums">
	});</p>
<p class="prettyprint lang-js linenums">
	// Contact form</p>
<p class="prettyprint lang-js linenums">
	var form = $(&#39;#main-contact-form&#39;);</p>
<p class="prettyprint lang-js linenums">
	form.submit(function(event){</p>
<p class="prettyprint lang-js linenums">
	event.preventDefault();</p>
<p class="prettyprint lang-js linenums">
	var form_status = $(&#39;&lt;div class=&quot;form_status&quot;&gt;&lt;/div&gt;&#39;);</p>
<p class="prettyprint lang-js linenums">
	$.ajax({</p>
<p class="prettyprint lang-js linenums">
	url: $(this).attr(&#39;action&#39;),</p>
<p class="prettyprint lang-js linenums">
	beforeSend: function(){</p>
<p class="prettyprint lang-js linenums">
	form.prepend( form_status.html(&#39;&lt;p&gt;&lt;i class=&quot;fa fa-spinner fa-spin&quot;&gt;&lt;/i&gt; Email is sending...&lt;/p&gt;&#39;).fadeIn() );</p>
<p class="prettyprint lang-js linenums">
	}</p>
<p class="prettyprint lang-js linenums">
	}).done(function(data){</p>
<p class="prettyprint lang-js linenums">
	form_status.html(&#39;&lt;p class=&quot;text-success&quot;&gt;&#39; + data.message + &#39;&lt;/p&gt;&#39;).delay(3000).fadeOut();</p>
<p class="prettyprint lang-js linenums">
	});</p>
<p class="prettyprint lang-js linenums">
	});</p>
<p class="prettyprint lang-js linenums">
	// Progress Bar</p>
<p class="prettyprint lang-js linenums">
	$.each($(&#39;div.progress-bar&#39;),function(){</p>
<p class="prettyprint lang-js linenums">
	$(this).css(&#39;width&#39;, $(this).attr(&#39;data-transition&#39;)+&#39;%&#39;);</p>
<p class="prettyprint lang-js linenums">
	});</p>
<p class="prettyprint lang-js linenums">
	if( $(&#39;#gmap&#39;).length ) {</p>
...
<p class="prettyprint lang-js linenums">
	panControl : false,</p>
<p class="prettyprint lang-js linenums">
	streetViewControl : false,</p>
<p class="prettyprint lang-js linenums">
	mapTypeControl: false,</p>
<p class="prettyprint lang-js linenums">
	overviewMapControl: false,</p>
<p class="prettyprint lang-js linenums">
	clickable: false</p>
<p class="prettyprint lang-js linenums">
	});</p>
...
<p class="prettyprint lang-js linenums">
	verticalAlign: &#39;bottom&#39;,</p>
<p class="prettyprint lang-js linenums">
	horizontalAlign: &#39;center&#39;,</p>
<p class="prettyprint lang-js linenums">
	backgroundColor: &#39;#3e8bff&#39;,</p>
<p class="prettyprint lang-js linenums">
	});</p>
<p class="prettyprint lang-js linenums">
	}</p>
...
<ul>
	...
	<li>
		<strong>jquery.isotope.min.js</strong> - An exquisite jQuery plugin for magical layouts</li>
	<li>
		<strong>jquery.prettyPhoto.js&nbsp;</strong>- prettyphoto jQuery plugin</li>
	<li>
		<strong>coundown-timer.js</strong>-Countdown Plugins</li>
	<li>
		<strong>comingsoon.js</strong></li>
	<li>
		<strong>contact.js</strong></li>
	<li>
		<strong>gmaps.js</strong></li>
	<li>
		<strong>jquery.fitvids.js</strong></li>
	<li>
...
<p>
	Finally thank you very much for purchasing this theme. Please keep that in mind that we are working very hard to providing better quality in coming days. If you love your work then appreciate us by writting a good review with 5 star.</p>
</section>
